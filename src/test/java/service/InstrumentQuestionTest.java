...
public class InstrumentQuestionTest {
    ...
    public void findByInstrumentTest() throws Exception {
        List<InstrumentQuestion> isq = instrumentQuestionService.findByInstrument(instrumentService.findById(2L).getId());
    ...
    public void findByQuestionTest() throws Exception {
        List<InstrumentQuestion> iqs = instrumentQuestionService.findByQuestion(questionService.findById(2L).getId());
