 ...
 */
@Embeddable
public class ElementRefResponseDomain implements IElementRef<ResponseDomain> {
    ...
    public ElementRefResponseDomain() {
    }

    public ElementRefResponseDomain(ResponseDomain responseDomain ) {
        setElement( responseDomain );
    }

    public ElementRefResponseDomain(Revision<Integer,ResponseDomain>revision ) {
        setElementRevision( revision.getRevisionNumber().get() );
    ...
    public boolean equals(Object o) {
        ...
        ElementRefResponseDomain that = (ElementRefResponseDomain) o;
