 ...
 */
@Embeddable
public class ElementRefCondition<T extends ControlConstruct> implements IElementRef<T> {
    ...
    private final ElementKind elementKind = ElementKind.CONDITION_CONSTRUCT;

    public ElementRefCondition() {
    }
...
//            setCondition( element.getCondition() );
    ...
    public boolean equals(Object o) {
        ...
        ElementRefCondition that = (ElementRefCondition) o;
