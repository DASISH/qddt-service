...
public class CategoryAuditController {
    ...
    public Revision<Long, Category> getLastRevision(@PathVariable("id") UUID id) {
        return auditService.findLastChange(id);
    }

    @RequestMapping(value = "/{id}/{revision}", method = RequestMethod.GET)
    public Revision<Long, Category> getByRevision(@PathVariable("id") UUID id, @PathVariable("revision") Long revision) {
        return auditService.findRevision(id, revision);
    }

    @RequestMapping(value = "/{id}/all", method = RequestMethod.GET)
    public HttpEntity<PagedResources<Revision<Long, Category>>> allProjects(
        ...
        Page<Revision<Long, Category>> entities = auditService.findRevisionByIdAndChangeKindNotIn(id,changekinds, pageable);
...
//    public Revision<Long, Category> getByVersion(@PathVariable("id") UUID id, @PathVariable("version") String version) {
