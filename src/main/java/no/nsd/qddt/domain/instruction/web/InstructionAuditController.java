...
public class InstructionAuditController {
    ...
    public Revision<Long, Instruction> getLastRevision(@PathVariable("id") UUID id) {
        return auditService.findLastChange(id);
    }

    @RequestMapping(value = "/{id}/{revision}", method = RequestMethod.GET)
    public Revision<Long, Instruction> getByRevision(@PathVariable("id") UUID id, @PathVariable("revision") Long revision) {
        return auditService.findRevision(id, revision);
    }

    @RequestMapping(value = "/{id}/all", method = RequestMethod.GET)
    public HttpEntity<PagedResources<Revision<Long, Instruction>>> allProjects(
        ...
        Page<Revision<Long, Instruction>> entities = auditService.findRevisionByIdAndChangeKindNotIn(id,changekinds, pageable);
