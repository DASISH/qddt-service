...
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (0, null, 0, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'NOTPUBLISHED', 'Not Published', 'Elements and discussion made available for key members of a questionnaire design sub group, but not designed to be published internally ');
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (1, null, 1, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'INTERNALPUBLICATION', 'Internal publication', null);
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (2, null, 2, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'EXTERNALPUBLICATION', 'External publication', null);
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (3, 1, 0, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'DESIGNMEETING1', 'Designmeeting1', 'Elements shared after first meeting to discuss questionnaire.');
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (5, 1, 2, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'DESIGNMEETING3', 'Designmeeting3', 'Elements shared  after third meeting to discuss questionnaire.');
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (4, 1, 1, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'DESIGNMEETING2', 'Designmeeting2', 'Elements shared after second meeting to discuss questionnaire.');
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (11, 1, 8, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'NO_MILESTONE', 'No Milestone', 'Use for publication of elements between key milestones.');
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (10, 1, 7, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'FINAL_SOURCE_SQPTMT', 'FinalSource – SQP/TMT', 'Elements agreed as going into the final source questionnaire.');
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (9, 1, 6, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'POST_PILOT', 'PostPilot', 'Elements reviewed on basis of the results from the pilot.');
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (8, 1, 5, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'PILOT_SQPTMT', 'Pilot – SQP/TMT', 'Elements agreed for pilot, export to SQP and translation');
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (7, 1, 4, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'POST_EARLY_TESTING', 'PostEarlyTesting', 'Elements reviewed on basis of the results from the early testing.');
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (6, 1, 3, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'EARLY_TESTING_SQPTMT', 'Earlytesting - SQP/TMT', 'Elements agreed for early pre-testing, export to SQP and translation.');
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (12, 2, 0, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'EXPORT_TO_PUBLIC_HISTORY', 'Export to Public History', 'In addition to the final elements, the development history will be made available to the public.');
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (14, 2, 2, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'EXPORT_TO_QVDB', 'Export to QVD', 'Once finalized, elements will be exported to the QVDB to be made publically available');
INSERT INTO publication_status (id, publication_status_id, publication_status_idx, agency_id, name, label, description) VALUES (13, 2, 1, '1359ded2-9f18-11e5-8994-feff819cdc9f', 'EXPORT_TO_PUBLIC', 'Export to Public', 'Elements agreed as going into the final source questionnaire.');
