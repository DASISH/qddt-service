...
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (1, null, null, 'Internal publication', 'INTERNALPUBLICATION', '1359ded2-9f18-11e5-8994-feff819cdc9f', null);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (10, 'Elements shared after first meeting to discuss questionnaire.', 0, 'Designmeeting1', 'Designmeeting1', '1359ded2-9f18-11e5-8994-feff819cdc9f', 1);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (12, 'Elements shared  after third meeting to discuss questionnaire.', 2, 'Designmeeting3', 'Designmeeting3', '1359ded2-9f18-11e5-8994-feff819cdc9f', 1);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (11, 'Elements shared after second meeting to discuss questionnaire.', 1, 'Designmeeting2', 'Designmeeting2', '1359ded2-9f18-11e5-8994-feff819cdc9f', 1);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (18, 'Use for publication of elements between key milestones.', 8, 'No Milestone', 'NoMilestone', '1359ded2-9f18-11e5-8994-feff819cdc9f', 1);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (17, 'Elements agreed as going into the final source questionnaire.', 7, 'FinalSource – SQP/TMT', 'FinalSourceSQPTMT', '1359ded2-9f18-11e5-8994-feff819cdc9f', 1);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (16, 'Elements reviewed on basis of the results from the pilot.', 6, 'PostPilot', 'PostPilot', '1359ded2-9f18-11e5-8994-feff819cdc9f', 1);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (15, 'Elements agreed for pilot, export to SQP and translation', 5, 'Pilot – SQP/TMT', 'PilotSQPTMT', '1359ded2-9f18-11e5-8994-feff819cdc9f', 1);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (14, 'Elements reviewed on basis of the results from the early testing.', 4, 'PostEarlyTesting', 'PostEarlyTesting', '1359ded2-9f18-11e5-8994-feff819cdc9f', 1);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (13, 'Elements agreed for early pre-testing, export to SQP and translation.', 3, 'Earlytesting - SQP/TMT', 'EarlytestingSQPTMT', '1359ded2-9f18-11e5-8994-feff819cdc9f', 1);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (2, null, null, 'External publication', 'EXTERNALPUBLICATION', '1359ded2-9f18-11e5-8994-feff819cdc9f', null);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (20, 'In addition to the final elements, the development history will be made available to the public.', 0, 'Export to Public History', 'ExportToPublic_History', '1359ded2-9f18-11e5-8994-feff819cdc9f', 2);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (22, 'Once finalized, elements will be exported to the QVDB to be made publically available', 2, 'Export to QVD', 'ExportToQVDB', '1359ded2-9f18-11e5-8994-feff819cdc9f', 2);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (21, 'Elements agreed as going into the final source questionnaire.', 1, 'Export to Public', 'ExportToPublic', '1359ded2-9f18-11e5-8994-feff819cdc9f', 2);
INSERT INTO publication_status (id, description, children_idx, label, name, agency_id, parent_id) VALUES (0, 'Elements and discussion made available for key members of a questionnaire design sub group, but not designed to be published internally ', null, 'Not Published', 'NOTPUBLISHED', '1359ded2-9f18-11e5-8994-feff819cdc9f', null);
