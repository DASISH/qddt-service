...
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('378949ec-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'Start','START','ENTITY','CODE','CREATED');
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('37894d7a-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'Slutt','SLUTT','ENTITY','CODE','CREATED');
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('37894f32-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'Range','RANGE-START-SLUTT','GROUP_ENTITY','RANGE','CREATED');
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('378953c4-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'NA','NA svar','ENTITY','CODE','CREATED');
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('378955cc-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'Vet ikke','NA svar','ENTITY','CODE','CREATED');
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('378955cd-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'Ikke svar','NA','GROUP_ENTITY','MULTIPLE_SINGLE','CREATED');
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('378955ce-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'Responsdomain Range','NA','ROOT_ENTITY','MIXED','CREATED');
...
INSERT INTO responsedomain_code (id, updated,  change_kind, name,   code_value,  category_id, responsedomain_id, user_id,agency_id) VALUES ('05f9a9c0-65d1-11e5-9d70-feff819cdc9f', '01-01-2015','CREATED', 'name', '66', '378953c4-65d0-11e5-9d70-feff819cdc9f','d5dbaebb-65d0-11e5-9d70-feff819cdc9f','83d4c39a-4ff9-11e5-885d-feff819cdc9f','1359dede-9f18-11e5-8994-feff819cdc9f');
