...
INSERT INTO question (id, updated,  change_kind, name, major, minor,   intent, question, user_id, agency_id, parent_id)
VALUES ('a9fe6c58-53ea-1875-8153-ea78ddcb0000','2016-04-06 09:28:22','CREATED','Q1',0,1,'test','What is your age?','83d4c034-4ff9-11e5-885d-feff819cdc9f','1359dede-9f18-11e5-8994-feff819cdc9f',(null));
INSERT INTO question (id, updated,  change_kind, name, major, minor,   intent, question, user_id, agency_id, parent_id)
VALUES ('a9fe6c58-53ea-1875-8153-ea78eb4f0001','2016-04-06 09:28:26','CREATED','Q2',0,1,'test','What is your gender?','83d4c034-4ff9-11e5-885d-feff819cdc9f','1359dede-9f18-11e5-8994-feff819cdc9f',(null));
INSERT INTO question (id, updated,  change_kind, name, major, minor,   intent, question, user_id, agency_id, parent_id)
VALUES ('a9fe6c58-53ea-1875-8153-ea78f8810002','2016-04-06 09:28:29','CREATED','Q3',0,1,'test','Where are you from?','83d4c034-4ff9-11e5-885d-feff819cdc9f','1359dede-9f18-11e5-8994-feff819cdc9f',(null));
INSERT INTO question (id, updated,  change_kind, name, major, minor,   intent, question, user_id, agency_id, parent_id)
VALUES ('a9fe6c58-53ea-1875-8153-ea790a700003','2016-04-06 09:28:34','CREATED','Q4',0,1,'test','Where do you live now?','83d4c034-4ff9-11e5-885d-feff819cdc9f','1359dede-9f18-11e5-8994-feff819cdc9f',(null)); --'a9fe6c58-53ea-1875-8153-ea78f8810002');
INSERT INTO question (id, updated,  change_kind, name, major, minor,   intent, question, user_id, agency_id, parent_id)
VALUES ('a9fe6c58-53ea-1875-8153-ea79192a0004','2016-04-06 09:28:38','CREATED','Q5',0,1,'test','Who do you belive?','83d4c034-4ff9-11e5-885d-feff819cdc9f','1359dede-9f18-11e5-8994-feff819cdc9f',(null));--'a9fe6c58-53ea-1875-8153-ea78f8810002');


--POPULATE THE RESPONSE PACKAGE WITH DATA.
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('378949ec-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'Start','START','ENTITY','CODE','MODIFIED');
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('37894d7a-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'Slutt','SLUTT','ENTITY','CODE','MODIFIED');
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('37894f32-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'Range','RANGE-START-SLUTT','GROUP_ENTITY','RANGE','MODIFIED');
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('378953c4-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'NA','NA svar','ENTITY','CODE','MODIFIED');
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('378955cc-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'Vet ikke','NA svar','ENTITY','CODE','MODIFIED');
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('378955cd-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'Ikke svar','NA','GROUP_ENTITY','MULTIPLE_SINGLE','MODIFIED');
INSERT INTO category(id,updated,label,name,hierarchy_level, category_kind,CHANGE_KIND) VALUES('378955ce-65d0-11e5-9d70-feff819cdc9f','01-01-2015 12:00:01.000', 'Responsdomain Range','NA','ROOT_ENTITY','MIXED','MODIFIED');
...
INSERT INTO responsedomain(id,updated,CHANGE_KIND,name,response_kind,category_id) VALUES('d5dbaebb-65d0-11e5-9d70-feff819cdc9f','01-01-2015','MODIFIED','Responsdomain Range','Scale','378955ce-65d0-11e5-9d70-feff819cdc9f');
INSERT INTO responsedomain(id,updated,CHANGE_KIND,name,response_kind) VALUES('d5dbb12a-65d0-11e5-9d70-feff819cdc9f','01-01-2015','MODIFIED','TestDomianCategory','Category');

INSERT INTO responsedomain_code (id, updated,  change_kind, name,  category_idx, code_value,  category_id, responsedomain_id) VALUES ('05f9a484-65d1-11e5-9d70-feff819cdc9f', '01-01-2015','MODIFIED', 'name', 1, '1', '378949ec-65d0-11e5-9d70-feff819cdc9f', 'd5dbaebb-65d0-11e5-9d70-feff819cdc9f');
INSERT INTO responsedomain_code (id, updated,  change_kind, name,  category_idx, code_value,  category_id, responsedomain_id) VALUES ('05f9a89e-65d1-11e5-9d70-feff819cdc9f', '01-01-2015','MODIFIED', 'name', 2, '9', '37894d7a-65d0-11e5-9d70-feff819cdc9f', 'd5dbaebb-65d0-11e5-9d70-feff819cdc9f');
INSERT INTO responsedomain_code (id, updated,  change_kind, name,  category_idx, code_value,  category_id, responsedomain_id) VALUES ('05f9a9c0-65d1-11e5-9d70-feff819cdc9f', '01-01-2015','MODIFIED', 'name', 3, '66', '378953c4-65d0-11e5-9d70-feff819cdc9f','d5dbaebb-65d0-11e5-9d70-feff819cdc9f');
INSERT INTO responsedomain_code (id, updated,  change_kind, name,  category_idx, code_value,  category_id, responsedomain_id) VALUES ('05f9abd2-65d1-11e5-9d70-feff819cdc9f', '01-01-2015','MODIFIED', 'name', 4, '67', '378955cc-65d0-11e5-9d70-feff819cdc9f','d5dbaebb-65d0-11e5-9d70-feff819cdc9f');


INSERT INTO responsedomain_code(id,updated,CHANGE_KIND, responsedomain_id, category_id, category_idx, code_value) VALUES('05f9ad12-65d1-11e5-9d70-feff819cdc9f','01-01-2015','MODIFIED', 'd5dbaebe-65d0-11e5-9d70-feff819cdc9f','378955cc-65d0-11e5-9d70-feff819cdc9f', 5,'15');
